  ...
  return (
    <Box p={[2, 3, 4]} bg={bg} color={textColor}>
      <Box bg={sectionBg} p={4} borderRadius="md" mb={8}>
        <Heading as="h1" size="lg" mb={3} textAlign="center">Contact Us</Heading>
        <Text mb={4} textAlign="center">We'd love to hear from you! Please fill out the form below to get in touch.</Text>
